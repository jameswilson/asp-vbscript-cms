...
<%
	...
	const strTableName = "tblModuleTypes" 'name of the principle database table to modify
	const strKey = "ModID"  'name of the primary key field in the database
	const strIdField = "ModName" 'name of the field that uniquely identifies a row from the database
