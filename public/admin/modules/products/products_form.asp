...
function buildFormContents(pk)
	...
	if sdContent("Image1") <> "" then imgPreview1 = img(objLinks.item("SITEURL")&"/"&sdContent("Image1"),"Image1","image-preview","")&imgText
	if sdContent("Image2") <> "" then imgPreview2 = img(objLinks.item("SITEURL")&"/"&sdContent("Image2"),"Image2","image-preview","")&imgText
