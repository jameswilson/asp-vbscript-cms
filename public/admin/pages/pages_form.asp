...
function buildFormContents(id)
	...
	if id <> "" then 
		...
		sdContent.Add "MainMenu",""&true
	end if
	if ""&sdContent("Active") = ""&true then strActive = "checked"
	if ""&sdContent("MainMenu") = ""&true then strMainMenu = "checked"
	...
	.addNote "File Name","The file name cannot be modified without taking further "_
					&"actions on your webserver. Please contact "&objLinks.item("PROVIDER_SUPPORT_EMAIL")&" " _
	...
	.addNote "What is Metadata?","Metadata is data about data, put plainly, its the important information explaining the regular " _
					...
					&"href=""mailto:"&objLinks.item("PROVIDER_EMAIL")&"?Request info about Search Engine Optimization"" " _
					&"title=""Request info about Search Engine Optimization"">contact "&objLinks.item("PROVIDER_SHORTNAME")&"</a> "
