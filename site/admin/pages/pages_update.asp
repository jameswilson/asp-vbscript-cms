	...
	if myForm.wasSubmitted() = true then 
		...
		if formErrors.count = 0 then 
			...
			strStatus = "The database content for the '"& myForm.getValue(strIdField) &"' "&strContent&" was updated. <br/>" & vbcrlf & _
					...
					"<li><a href='"&objLinks.item("SITEURL")&"/"&myForm.getValue("PageFileName")&"' target='_blank'>View Your Updates For "&PCase(strContent)&" '"&myForm.getValue(strIdField)&"' On Live Site</a></li>" & vbcrlf & _
